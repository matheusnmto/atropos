...
const translations = {
  'en-US': {
    ...
    // Active Notes
    'active.title':      'Active Notes',
    'active.desc':       'Healthy notes currently being monitored by the decay cycle.',
    'active.empty':      'No active notes found.',
    'active.colNote':    'Note',
    'active.colFolder':  'Folder',
    'active.immunize':   'Immunize',

    // Immune Notes
    'immune.title':      'Immune Notes',
    'immune.desc':       'Protected notes that will never be affected by decay.',
    'immune.empty':      'No immune notes found.',
    'immune.colNote':    'Note',
    'immune.colFolder':  'Folder',
    'immune.remove':     'Remove Immunity',

    // Action
    'action.openOb':     'Open in Obsidian',
    'action.open':       'Open',
    'action.viewArchived': 'View archived',
    ...
    'insig.desc':      'Smart signals discovered in your vault.',
    ...
    'insig.faster':    'faster',
    'insig.expiredDates': 'Contains expired date(s)'
  },
  ...
  'pt-BR': {
    ...
    // Active Notes
    'active.title':      'Notas Ativas',
    'active.desc':       'Notas saudáveis que estão sendo monitoradas pelo ciclo de decaimento.',
    'active.empty':      'Nenhuma nota ativa encontrada.',
    'active.colNote':    'Nota',
    'active.colFolder':  'Pasta',
    'active.immunize':   'Imunizar',

    // Immune Notes
    'immune.title':      'Notas Imunes',
    'immune.desc':       'Notas protegidas que nunca serão afetadas pelo decaimento.',
    'immune.empty':      'Nenhuma nota imune encontrada.',
    'immune.colNote':    'Nota',
    'immune.colFolder':  'Pasta',
    'immune.remove':     'Remover Imunidade',

    // Action
    'action.openOb':     'Abrir no Obsidian',
    'action.open':       'Abrir',
    'action.viewArchived': 'Ver arquivada',
    ...
    'ob.noKey':        'Insira uma chave de API',
    ...
    'insig.desc':      'Sinais inteligentes descobertos no seu vault.',
    ...
    'insig.faster':    'mais rápido',
    'insig.expiredDates': 'Contém data(s) expirada(s)'
  },
};
